...
# # Sweep parameters
n_steps = 50  # Number of steps in the sweep
taup = jnp.linspace(
    0, 9, n_steps
...
n_res = 12  # Number of points inside the bandwidth of the phase-matching function in the frequency grid nxnxnxn
...
print(
    n
)  # Note: Always check the frequency vector size, because later we are going to build a 4D grid with it, which greatly affects  the memory usage.
